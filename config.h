...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_i,          spawn,                  SHCMD ("brightnessctl s +5%")}, // increase backlight brightness
    { MODKEY|ShiftMask,             XK_t,          spawn,                  SHCMD ("brightnessctl s 5%-")}, // decrease backlight brightness
    { MODKEY|ShiftMask,             XK_i,          spawn,                  SHCMD ("brightnessctl s +5%")}, // increase backlight brightness
    { MODKEY|ShiftMask,             XK_t,          spawn,                  SHCMD ("brightnessctl s 5%-")}, // decrease backlight brightness
