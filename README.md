...
**I recommend to use [manual](https://github.com/harilvfs/dwm/blob/main/.github/manual.md) way to setup and install dwm. But if you perfer a easy way then, Follow Installation Script:**
